...
Aqui eu organizo todos os cursos, bootcamps e formações que concluí ao longo da minha jornada como desenvolvedor, com foco em C#, .NET, backend, boas práticas e Inteligência Artificial.

Este repositório existe para facilitar:
- Validação de habilidades  
- Processo seletivo  
- Organização dos meus estudos  
- Transparência da minha evolução profissional  
